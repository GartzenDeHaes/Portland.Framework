...
namespace Portland.Text
{
	public struct StringTabRef
	{
		...
		public StringTabRef(int idx, int len)
		{
			_idx = (short)idx;
			_len = (short)len;
		}
		...
		/// <summary>==</summary>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool operator ==(StringTabRef s1, String s2)
		{
		...
		/// <summary>==</summary>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool operator ==(StringTabRef s1, String8 s2)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static implicit operator string(StringTabRef s) => s.ToString();
		/// <summary>Implicit string to String8 cast</summary>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static implicit operator StringTabRef(string x) => Variant8.StrTab.Get(x);
	}
}
