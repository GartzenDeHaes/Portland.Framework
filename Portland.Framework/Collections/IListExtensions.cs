...
public static class IListExtensions
{
	...
	/// <param name="list">List to insert into</param>
	/// <param name="value">Value to insert</param>
	/// <param name="comparison">Comparison to determine sort order with. A negative return means that the first
	/// item is to the left of the second item.</param>
	public static void InsertIntoSortedList<T>(this IList<T> list, T value, Func<T, T, int> comparison)
	{
		var startIndex = 0;
		var endIndex = list.Count;
