...
//		/// <summary>
//		/// Gets whether or not the provided <see cref="Vector2f"/> lies within the bounds of this <see cref="Rectangle"/>.
//		/// </summary>
//		/// <param name="value">The coordinates to check for inclusion in this <see cref="Rectangle"/>.</param>
//		/// <returns><c>true</c> if the provided <see cref="Vector2f"/> lies inside this <see cref="Rectangle"/>; <c>false</c> otherwise.</returns>
...
//		/// </summary>
//		/// <param name="value">The coordinates to check for inclusion in this <see cref="Rectangle"/>.</param>
//		/// <param name="result"><c>true</c> if the provided <see cref="Vector2f"/> lies inside this <see cref="Rectangle"/>; <c>false</c> otherwise. As an output parameter.</param>
