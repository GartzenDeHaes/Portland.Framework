...
namespace Portland.Mathmatics
{
	...
	public struct Vector3i //: IEquatable<Vector3i>
	{
		...
		public static Vector3i operator +(in Vector3i l, in Vector3i r)
		{
		...
		public static bool operator ==(in Vector3i l, in Vector3i r)
		{
		...
		public static Vector3i operator -(in Vector3i arg)
		{
			return new Vector3i(-arg.X, -arg.Y, -arg.Z);
		}

		public static Vector3i operator *(in Vector3i v, int a)
		{
			return new Vector3i(a * v.X, a * v.Y, a * v.Z);
		}

		public static Vector3i operator *(int a, in Vector3i v)
		{
			return new Vector3i(a * v.X, a * v.Y, a * v.Z);
		}
