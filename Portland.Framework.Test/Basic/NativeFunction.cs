	...
	internal sealed class NativeFunction
	{
		...
		public void CallbackTest()
		{
			...
			bas.GetFunctionBuilder()
				.Add("STAT", (statId) => { printOut.Append("STAT"); printOut.Append(statId.ToString()); return statId.Equals("STR") ? new Variant(8) : new Variant(6); })
		...
		public void SubsWithDiffArgCountsTest()
		{
			...
			bas.GetFunctionBuilder()
				.Add("STAT", (statId) => { printOut.Append("GET"); printOut.Append(statId.ToString()); return statId.Equals("STR") ? new Variant(8) : new Variant(6); })
		...
		public void RepeatTest()
		{
			...
			bas.GetFunctionBuilder()
				.Add("STAT", (statId) => { return statId.Equals("STR") ? new Variant(str) : new Variant(0); })
				.Add("SETSTAT", (statId, value) => { if (statId.Equals("HP")) hp = value.ToFloat(); else if (statId.Equals("STR")) str = value.ToFloat(); return value; });
