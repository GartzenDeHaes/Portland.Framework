...
namespace MonoGame.Tests.Framework
{
	class Vector2Test
	{
		...
		public void Transform()
		{
			...
			Vector2.Transform(v1, m1, out result1);
			Vector2.Transform(v2, q2, out result2);
		...
		public void TransformNormal()
		{
			...
			Vector2 result;
			Vector2.TransformNormal(normal, matrix, out result);
		...
		public void Round()
		{
			...
			Vector2 ceilResult;
			Vector2.Ceiling(vector2, out ceilResult);
			...
			Vector2 floorResult;
			Vector2.Floor(vector2, out floorResult);
			...
			Vector2 roundResult;
			Vector2.Round(vector2, out roundResult);
